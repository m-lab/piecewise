    ...
    const applicationImports = assignImportedComponents([
           [() => import('./components/Admin.jsx'), '', './src/frontend/components/Admin.jsx', false],
      [() => import('./components/Basic.jsx'), '', './src/frontend/components/Basic.jsx', false],
      [() => import('./components/Loading.jsx'), '', './src/frontend/components/Loading.jsx', false],
      [() => import('./components/Login.jsx'), '', './src/frontend/components/Login.jsx', false],
      [() => import('./components/ThankYou.jsx'), '', './src/frontend/components/ThankYou.jsx', false],
    ]);
